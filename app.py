...
st.markdown(
    """
    이 애플리케이션은 업로드된 연수 계획서의 내용을 분석하여 디지털 배지의 설명과 발급 조건을 생성합니다.
    1. 먼저, 사이드바에서 연수 계획서를 업로드합니다.
    2. 그 다음, 연수 내용 기준과 연수 단계를 선택합니다.
    3. 마지막으로 '생성하기' 버튼을 클릭하면 AI가 디지털 배지 설명과 발급 조건을 생성합니다.
    4. 본 앱은 업무보조용으로 개인이 만든 앱으로 서울시교육청 공식 사이트가 아닙니다.
    5. 만든이: 융합과학교육원 동부분원 정용석
    """
)
